...
def attention_decoder(decoder_inputs, initial_state, encoder_states, question_states, enc_padding_mask, cell, initial_state_attention=False, pointer_gen=True, use_coverage=False, prev_coverage=None):
  """
  Args:
  ...
  with variable_scope.variable_scope("attention_decoder") as scope:
    ...
    question_states = tf.reduce_mean(question_states, axis=1)
    question_features = tf.expand_dims(tf.expand_dims(question_states, axis=1), axis=1)
    ...
    def attention(decoder_state, coverage=None):
      ...
      with variable_scope.variable_scope("Attention"):
        ...
        if use_coverage and coverage is not None: # non-first step of coverage
          ...
          e = math_ops.reduce_sum(math_ops.tanh(encoder_features + decoder_features + question_features), [2, 3]) # calculate e
